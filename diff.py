...
#線形化を行うために微分のところを実装する試み.
#This program is the trial which concerns about differntiation of the map in order to do linearlization around fixed (periodic) point.
xb = 1
k = 1.2
e2 = 1
dimension = 2
